...
export default function EditAvatarPopup(props) {
    ...
    React.useEffect(() => { // Очищать поля форм нужно при открытии, а не при сабмите, иначе, в случае ошибки на сервере, форма останется открытой, но ее поля уже будут очищены и пользователь не сможет повторить попытку отправки данных.
